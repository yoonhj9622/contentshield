...
import { userService } from '../../services/userService';//윤혜정
import { analysisService } from '../../services/analysisService';//윤혜정
//import React, { useState } from 'react';윤혜정
import { 
...
//윤혜정function ProfileView() { return <div className="text-center p-20 text-slate-500">Secure Profile Settings...</div>; }